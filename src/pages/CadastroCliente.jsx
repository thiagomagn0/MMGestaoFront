...
const [form, setForm] = useState({
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md border-t-4 color-red-mm-txt">
      <h2 className="text-2xl font-semibold color-red-mm-txt mb-6 text-center">Cadastro de Cliente</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <input
          ...
          className="w-full border-b border-gray-300 focus:outline-none focus:color-red-mm-txt text-sm py-2 placeholder-gray-400"
          required
        />
        ...
        <select
          ...
          className="w-full border-b border-gray-300 focus:outline-none focus:color-red-mm-txt text-sm py-2 bg-transparent"
        >
